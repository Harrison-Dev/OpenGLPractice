...
int main()
{
	...
	Shader shader("../GLCore/src/shader/texture_vert.glsl", "../GLCore/src/shader/texture_frag.glsl");
	Shader screenShader("../GLCore/src/shader/fb_vert.glsl", "../GLCore/src/shader/fb_frag.glsl");
	Shader skyboxShader("../GLCore/src/shader/cubemap_vert.glsl", "../GLCore/src/shader/cubemap_frag.glsl");
	Shader reflecthader("../GLCore/src/shader/reflect_vert.glsl", "../GLCore/src/shader/reflect_frag.glsl");
	Shader litObjShader("../GLCore/src/shader/vert.glsl", "../GLCore/src/shader/frag.glsl");
	...
	Model testModel("../GLCore/models/nanosuit_reflection/nanosuit.objl");

	unsigned int floorTexture = loadTexture("../GLCore/src/textures/metal.png");
	unsigned int transparentTexture = loadTexture("../GLCore/src/textures/blending_transparent_window.png");
	unsigned int cubeTexture = loadTexture("../GLCore/src/textures/container2.png");
	...
	{
		"../GLCore/src/textures/skybox/right.jpg",
		"../GLCore/src/textures/skybox/left.jpg",
		"../GLCore/src/textures/skybox/top.jpg",
		"../GLCore/src/textures/skybox/bottom.jpg",
		"../GLCore/src/textures/skybox/front.jpg",
		"../GLCore/src/textures/skybox/back.jpg"
	};
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// cubes
		reflecthader.use();
		reflecthader.setMat4("model", model);
		reflecthader.setMat4("view", view);
		reflecthader.setMat4("projection", projection);
		reflecthader.setVec3("cameraPos", camera.Position);
		...
		litObjShader.setInt("material.skybox", 3);
		glActiveTexture(GL_TEXTURE3);
		glBindTexture(GL_TEXTURE_CUBE_MAP, cubemapTexture);
		DrawModel(litObjShader, testModel, 0.2);
